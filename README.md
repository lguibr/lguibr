<table>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <code>Python</code> <code>LangChain</code> <code>CLI</code>
      </p>
    </td>
    <td width="50%">
      <div align="center">
      ...
      <p align="center">
        <code>Python</code> <code>CLI</code> <code>Context</code>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <code>Next.js</code> <code>React</code> <code>Vercel</code>
      </p>
    </td>
    <td width="50%">
      <div align="center">
      ...
      <p align="center">
        <code>Go</code> <code>WebSockets</code> <code>Concurrency</code>
      </p>
      <hr />
      ...
      <div align="center">
        ...
        <br/>
        <code>TypeScript</code> <code>SDK</code> <code>Networking</code>
      </div>
      <br />
      <div align="center">
        ...
        <br/>
        <code>Go</code> <code>ECS</code> <code>Game Logic</code>
      </div>
    </td>
  </tr>
  <tr>
    ...
    <td width="50%">
      ...
      <p align="center">
        <code>PyTorch</code> <code>RL</code> <code>MCTS</code>
      </p>
      <hr />
      <p align="center"><b>Family of Dependencies</b></p>
      <div align="center">
        ...
        <br/>
        <code>C++</code> <code>Python</code> <code>Engine</code>
      </div>
      <br />
      <div align="center">
        ...
        <br/>
        <code>C++</code> <code>Python</code> <code>MCTS</code>
      </div>
      <br />
      <div align="center">
        ...
        <br/>
        <code>Python</code> <code>Ray</code> <code>MLOps</code>
      </div>
    </td>
  </tr>
  <tr>
    ...
    <td width="50%">
      ...
      <p align="center">
        <code>Utility</code> <code>Systems</code> <code>Data</code>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <code>Performance</code> <code>Metrics</code> <code>Tooling</code>
      </p>
    </td>
    <td width="50%">
      <div align="center">
      ...
      <p align="center">
        <code>React</code> <code>AlphaTriangle</code> <code>Game</code>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <code>TypeScript</code> <code>Vitest</code> <code>TUI</code>
      </p>
    </td>
    <td width="50%">
      <div align="center">
